...
class Game{
 ...
 Future<void> autoPlay (activePlayer) async {
   ...
   if (Player.playerY.containsAll(0,1) && emptyCells.contains(2))
     ...
     index = 8;
   else if (Player.playerY.containsAll(0,4) && emptyCells.contains(8))
     index = 8;
   else if (Player.playerY.containsAll(2,4) && emptyCells.contains(6))
     index = 6;

   //Start - End
   if (Player.playerY.containsAll(0,2) && emptyCells.contains(1))
     index = 1;
   ...
   // Center - End
   if (Player.playerY.containsAll(1,2) && emptyCells.contains(0))
     index = 0;
     ...
     index = 8;
   else if (Player.playerY.containsAll(2,4) && emptyCells.contains(8))
     index = 8;
